            ...
            {route.params.debts.length === 0 ? (
              <View className="mt-8 items-center">
                <Text
                  ...
                  style={{
                    fontSize: Math.floor(SizeConfig.textMultiplier * 2.4),
                  }}>
        ...
        <View className="absolute bottom-4 w-full items-center">
          ...
          <View className="mt-2 justify-center">
            <TouchableOpacity
              ...
              onPress={() =>
                EventRegister.emit('canShowTheDebtConfimationModal', {
                  canShowTheModal: true,
                  dividaId: route.params.debts.filter(
                    debt =>
                      debt.dataPagamento === null ||
                      debt.dataPagamento === undefined,
                  )[0].id,
